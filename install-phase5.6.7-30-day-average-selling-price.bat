...
echo ======================================================
echo Phase 5.6.7 - 30-Day Average Selling Price Authority
echo ======================================================
echo.
...
set BACKUP=backups\phase5.6.7-source-before-%STAMP%
...
echo Column H and every scanner calculation will use Cardmarket 30-day
echo average selling price after update-pokemon-market-daily.bat completes.
goto :end
