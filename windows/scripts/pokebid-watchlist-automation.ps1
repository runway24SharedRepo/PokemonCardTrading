...
function Show-Status {
    ...
    Write-Log ("PROCESSED SEARCH | {0} | completed={1} | checked={2} | matched={3} | added={4} | failed={5}" -f $processedName, $processedAt, $processedChecked, $processedMatches, $processedAdded, $processedFailed)
