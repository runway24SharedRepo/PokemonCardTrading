...
echo ======================================================
echo Phase 5.7.1 - Resumable Cardmarket 30-Day Pricing
echo ======================================================
echo.
...
if not exist "payload\on_demand_pricing.py" (
  echo ERROR: The Phase 5.7.1 payload is missing or incomplete.
  goto :failed
)

for /f %%I in ('powershell -NoProfile -Command "Get-Date -Format yyyyMMdd-HHmmss"') do set STAMP=%%I
set BACKUP=backups\phase5.7.1-source-before-%STAMP%
...
echo Successful prices are shared for 24 hours in the resumable cache.
